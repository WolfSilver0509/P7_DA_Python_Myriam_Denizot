...
print(f'Le meilleur profit est de {best_total_profit}€ pour la combinaison suivante :')
for element in best_combination:
    print(element['name'])
# print(best_combination)
print(f'Le prix total de cette combinaison est de {sumcomb(best_combination)}€')
# total_price = sumcomb(best_combination)
# print(total_price)

# comparer le temps d'exécution et remettre au propre les prints avec des phrases plus juste nom des actions
